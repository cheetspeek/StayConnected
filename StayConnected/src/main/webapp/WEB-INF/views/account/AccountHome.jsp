...
<body>
	...
	<header>
		<img class="alt-logo" src="<s:url value="/resources/images/alt_logo.png" />" 
			width="237" height="50" />
		<a href="j_spring_security_logout"> 
			<img class="header_box" src="<s:url value="/resources/images/nav/log_out_box.png" />" 
			width="93" height="35" />
		</a>
		<a href="${contextPath}/"> 
			<img class = "header_box" src="<s:url value="/resources/images/nav/home_box.png" />" 
			width="93" height="35"/>
		</a>
	</header>
